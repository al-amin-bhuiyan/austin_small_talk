...
class VerifiedScreenFromVerifyEmail extends StatelessWidget {
  const VerifiedScreenFromVerifyEmail({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<VerifiedControllerFromVerifyEmail>();
