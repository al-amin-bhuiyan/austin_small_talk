...
/// A project-wide button that uses the image background defined in `CustomAssets.button_background`.
///
/// Visual behavior:
...
class CustomStartConversationButton extends StatelessWidget {
  final String label;
  ...
  const CustomStartConversationButton({
    Key? key,
    required this.label,
    this.onPressed,
  ...
  Widget build(BuildContext context) {
    final double _height = height ?? 44.h;
    final BorderRadius _radius = (borderRadius as BorderRadius?) ?? BorderRadius.circular(12.r);
        ...
        child: Material(
          ...
          child: Stack(
            ...
            children: [
              ...
              Image.asset(
                CustomAssets.start_conversation_button_background ,
                fit: BoxFit.cover,
